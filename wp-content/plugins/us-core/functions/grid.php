...
/**
 * Removing `orderby` and `order` from get for grid_order or grid_filters
 */
global $us_get_orderby, $pagenow;
if (
	$us_order_key = us_get_grid_url_prefix( 'order' )
	// The `order` and `orderby` parameters are used by many plugins and by WordPress itself,
	// and such a name in custom sorts can cause problems
