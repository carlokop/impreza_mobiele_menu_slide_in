...
if ( $show_on == 'image' ) {
	...
	if ( us_amp() ) {
		$image_atts['on'] = 'tap:' . $_amp_ID . '.open,' . $_amp_ID . '.toggleClass(class=\'opened\')';
	} else {
		$image_atts['href'] = 'javascript:void(0)';
	}
	...
	if ( us_amp() ) {
		$btn_atts['on'] = 'tap:' . $_amp_ID . '.open,' . $_amp_ID . '.toggleClass(class=\'opened\')';
	} else {
		$btn_atts['href'] = 'javascript:void(0)';
	}
